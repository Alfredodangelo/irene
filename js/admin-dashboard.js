    ...
    list.innerHTML = upcoming.map(a => {
        ...
        <div class="upcoming-item" onclick="openClientDetail('${safeClientId}')" style="cursor:pointer;">
            ...
            <div style="flex:1;text-align:center;min-width:0;">
                ...
                ${(() => { const mv = a.notes?.match(/Motivo video:\s*(.+)/i); return mv && /whatsapp|video/i.test(a.consultation_mode) ? `<div style="font-size:0.72rem;color:#e8a435;margin-top:3px;font-style:italic;text-align:center;"><i class="fab fa-whatsapp" style="margin-right:3px;"></i>"${mv[1].trim()}"</div>` : ''; })()}
            </div>
